...
if VERBOSE == 1:
    print(f'The weights before playing are: {AGENT.model.get_weights()}')
...
if VERBOSE == 1:
    ...
    print('We have generated data points. This took {} to run'.
...
if TRAINING == 1:
    ...
    if VERBOSE == 1:
        print('The models weights after playing are:',
              f'{AGENT.model.get_weights()}')
        print('The weights were saved! Now the model will be retrained',
